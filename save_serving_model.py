...
config_pathname = 'output\\philip_morris_with_new_dataset\\ssd_resnet50_v1_fpn_shared_box_predictor_640x640_coco14_sync.config'

# Input checkpoint for the model to be exported
# Path to the directory which consists of the saved model on disk (see above)
trained_model_dir = "output\\philip_morris_with_new_dataset\\train"
...
# Output Directory
output_directory = "output\\philip_morris_with_new_dataset\\serving\\" + str(model_version_id)
