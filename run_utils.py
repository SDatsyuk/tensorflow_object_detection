...
def list_dir(path, output):
  # print(path)
  # print(glob.glob1(path, '*.xml'))
  with open(output, 'w') as f:
    f.write('\n'.join(glob.glob1(path, '*.xml')))
  return output
...
def get_configs_from_pipeline_file(path):
  ...
  input_config = pipeline_config.train_input_reader, pipeline_config.eval_input_reader
